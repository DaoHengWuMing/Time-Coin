...
\*\*Единственный метод, способный полностью устранить эксплуатацию, — это полная, безусловная прозрачность.\*\*
...
\## Три незыблемых основных правила
...
Экономическая жизнь физического устройства обладает абсолютной исключительностью. Когда чип PUF устройства впервые активируется любым совместимым клиентом на основе данного протокола, внутри защищённого анклава PUF генерируется необратимый флаг «блокировки протокола». Будучи однажды заблокирован, этот чип PUF на физическом уровне абсолютно отказывается выполнять рукопожатие или вычисление подписи с любым другим клиентом форка протокола.
...
\## Философская декларация Тайм-Коина
